...
public class DragonBallContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DragonBallCharacter>().HasData(
            ...
            new DragonBallCharacter(5, "Frieza", "Frost Demon", "Unknown", "Black Frieza", "Death Ball", "https://dragonballstorage.blob.core.windows.net/characters/frieza/frieza.jpg")
        );
    }
}